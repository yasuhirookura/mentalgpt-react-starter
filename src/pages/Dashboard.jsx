...
// ← 本番のデプロイURL（末尾スラなし）※ローカル時だけこれを使います
const PROD_BASE =
    ...
    <main className="container" style={{ maxWidth: 820, marginTop: 0, paddingTop: 0 }}>
      ...
      <div
        ...
        style={{
          ...
          borderRadius: 12,
          padding: "12px 12px 92px", // 下に入力欄のぶん余白
          minHeight: "52vh",
          maxHeight: "72vh",
          overflowY: "auto",
          background: "#fff",
      ...
      >
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              borderRadius: "999px",
              border: "none",
              background: isLoading || !text.trim() || over || todayCount >= planLimit ? "#9bbcf7" : "#0a6cff",
              color: "#fff",
              display: "grid",
              placeItems: "center",
              cursor: isLoading || !text.trim() || over || todayCount >= planLimit ? "not-allowed" : "pointer",
            }}
          >
            {/* 青い円に白い三角形（送信アイコン） */}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 6 }}>
          ...
          {isLoading && (
            <span style={{ fontSize: 12, color: "#0a6cff", marginLeft: 8 }}>{hint}</span>
          )}
        </div>
      </div>
    </main>
